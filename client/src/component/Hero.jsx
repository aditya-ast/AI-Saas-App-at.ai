  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center bg-[url('/gradientBackground.png')] bg-cover bg-no-repeat py-32 px-2 sm:px-8 md:px-16 lg:px-24">
      <div className="text-center mb-8">
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold mx-auto leading-tight drop-shadow-lg">
          Create Amazing Content <br />
          with{" "}
          <span className="text-primary bg-gradient-to-r from-blue-600 to-purple-500 bg-clip-text text-transparent">
            AI tools
          </span>
        </h1>
      ...
      <div className="flex gap-4 justify-center mt-8">
        ...
        >
          <span className="inline-block drop-shadow">Start creating now</span>
        </button>
        <button className="px-8 py-3 rounded-xl font-semibold text-base sm:text-lg bg-white/80 text-blue-700 shadow-lg border border-blue-600 hover:bg-blue-600 hover:text-white hover:scale-105 hover:shadow-2xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400">
          <span className="inline-block drop-shadow">Watch demo</span>
        </button>
      </div>
